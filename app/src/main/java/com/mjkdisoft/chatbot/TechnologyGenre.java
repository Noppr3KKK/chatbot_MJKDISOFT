...
import com.mjkdisoft.chatbot.databinding.BotLayout2Binding;
import com.mjkdisoft.chatbot.databinding.BotLayout4Binding;
import com.mjkdisoft.chatbot.databinding.HumanLayout2Binding;
import com.mjkdisoft.chatbot.databinding.HumanLayout4Binding;
...
public class TechnologyGenre extends AppCompatActivity{
        private RecyclerView recyclerView;
        private ChatAdapter chatAdapter;
        private List<ChatModel> chatList;
        private BotLayout4Binding binding;
        private HumanLayout4Binding humanBinding;
        ...
        private boolean isTechnology = true;

        @Override
        protected void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            setContentView(R.layout.genre_technology_act);

            binding = BotLayout4Binding.inflate(getLayoutInflater());
            humanBinding = HumanLayout4Binding.inflate(getLayoutInflater());
            ...
            chatAdapter = new ChatAdapter(chatList, false, false, isTechnology);
            ...
            binding.bot.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(TechnologyGenre.this, "AI Response", Toast.LENGTH_SHORT).show();
                }
            });
            ...
            humanBinding.human.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(TechnologyGenre.this, "User Response", Toast.LENGTH_SHORT).show();
                }
            });
        ...
        private void initializeResponses() {
            ...
            responses.put("makanan favoritmu", "Aku sih, biasanya suka makan pedas pedas contohnya seblak, bakso, dll");
