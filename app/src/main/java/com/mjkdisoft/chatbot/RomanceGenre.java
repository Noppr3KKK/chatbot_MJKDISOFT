...
public class RomanceGenre extends AppCompatActivity {

    private RecyclerView recyclerView;
    private ChatAdapter chatAdapter;
    private List<ChatModel> chatList;
    private BotLayout2Binding binding;
    private HumanLayout2Binding humanBinding;
    ...
    private boolean isRomance = true; // Menentukan apakah konteks saat ini adalah Romance

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.genre_romance_act);

        binding = BotLayout2Binding.inflate(getLayoutInflater());
        humanBinding = HumanLayout2Binding.inflate(getLayoutInflater());
        ...
        chatAdapter = new ChatAdapter(chatList, isRomance, false, false);
        ...
        binding.bot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(RomanceGenre.this, "AI Response", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        humanBinding.human.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(RomanceGenre.this, "User Response", Toast.LENGTH_SHORT).show();
            }
        });
