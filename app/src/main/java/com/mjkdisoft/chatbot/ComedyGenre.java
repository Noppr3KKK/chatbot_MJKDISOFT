...
public class ComedyGenre extends AppCompatActivity {
    ...
    private boolean isComedy = true;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.genre_comedy_act);
        ...
        chatAdapter = new ChatAdapter(chatList, false, isComedy, false);
        ...
        binding.bot.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(ComedyGenre.this, "AI Response", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        humanBinding.human.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(ComedyGenre.this, "User Response", Toast.LENGTH_SHORT).show();
            }
        });
